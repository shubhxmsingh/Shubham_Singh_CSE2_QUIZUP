...
-- CreateIndex
CREATE UNIQUE INDEX "_AssignedQuizzes_AB_unique" ON "_AssignedQuizzes"("A", "B");

-- CreateIndex
CREATE INDEX "_AssignedQuizzes_B_index" ON "_AssignedQuizzes"("B");
...
-- AddForeignKey
ALTER TABLE "_AssignedQuizzes" ADD CONSTRAINT "_AssignedQuizzes_A_fkey" FOREIGN KEY ("A") REFERENCES "Quiz"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_AssignedQuizzes" ADD CONSTRAINT "_AssignedQuizzes_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
